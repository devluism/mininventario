<div class="modal-header">
    <h5 class="modal-title" id="incomingModalTitle">{{ 'Registrar entrada' }}</h5>
    <button type="button" class="btn-close box-shadow-0" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form method="POST" action="{{ route('product.incoming') }}" id="incomingForm">
    @csrf
    <div class="modal-body px-2 mx-auto">
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <label for="amountInput" class="form-label">Cantidad entrante</label>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success"><i class="fas fa-arrow-up me-2"></i>Registrar entrada</button>
